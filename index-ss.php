    ...
    <body>
        ...
        <!--div class="cover"></div-->
            <video onclick="return checkers(this)" style="position:relative !important; width: 100% !important; height: 100% !important; bottom:0;" id="vid" class="video-js vjs-default-skin" preload="auto" width="100%" height="100%" data-setup="{}" autoplay onclick="document.getElementsByTagName('video')[0].play()" poster="">
                <source src="http://sandbox.strippershark.com/assets/media/video/SS_150308_VSL_1_all.mp4" type="video/mp4 codecs='avc1.42E01E, mp4a.40.2'"/>
                <source src="http://sandbox.strippershark.com/assets/media/video/SS_150308_VSL_1_all.webm" type="video/webm "/>
                <source src="http://sandbox.strippershark.com/assets/media/video/SS_150308_VSL_1_all.ogg" type="video/ogg "/>
                <source src="http://sandbox.strippershark.com/assets/media/video/SS_150308_VSL_1_all.flv" type="video/flv"/>
            </video>
        </div>
